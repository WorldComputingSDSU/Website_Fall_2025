        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full flex justify-center">
              <iframe
                src="https://www.linkedin.com/embed/feed/update/urn:li:share:7401738784716898304?collapsed=1"
                height="671"
                width="504"
                frameBorder="0"
          ...
          <div className="flex flex-col items-center md:col-span-2 lg:col-span-1">
            ...
            <div className="w-full flex justify-center">
              <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/wcosdsu/?utm_source=ig_embed&amp;utm_campaign=loading"
                ...
                <div style={{ padding: "16px" }}>
                  <a
                    href="https://www.instagram.com/wcosdsu/?utm_source=ig_embed&amp;utm_campaign=loading"
                    style={{
                      background: "#FFFFFF",
                      lineHeight: 0,
                      padding: "0 0",
